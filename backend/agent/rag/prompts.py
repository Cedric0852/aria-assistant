...
# System prompt for the Citizen Support Assistant
...
# QA Prompt template for RAG queries
...
# Refined prompt for follow-up questions
...
# Prompt for clarifying vague questions
...
# Prompt for synthesizing multiple sources
